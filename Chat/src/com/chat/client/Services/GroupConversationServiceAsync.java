...
public interface GroupConversationServiceAsync {
    void getGroupConversation(int conversationId, int lastmessagenumber, AsyncCallback<GroupConversation> async);
    ...
    void createGroupConversation(User hostUser, String name, AsyncCallback<GroupConversation> async);
